...
export interface WagyuToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  ...
  wagyuThickness: "wagyuThickness",
  wagyuTwoOffset: "wagyuTwoOffset",
  wagyuThreeOffset: "wagyuThreeOffset",
  butterTop: "butterTop",
